...
This script processes Docusaurus markdown content, chunks it, generates embeddings,
and stores the vectors in Qdrant Cloud.
"""
...
# Add the backend and ingestion paths
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..', '..', 'backend'))
sys.path.insert(0, os.path.join(os.path.dirname(__file__), '..'))

from src.parsers.markdown_parser import markdown_parser
from src.loaders.vector_loader import vector_loader
